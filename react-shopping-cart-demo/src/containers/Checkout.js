...
class Checkout extends Component {
  ...
  componentDidMount() {
    ...
    //digitalData.page.pageInfo.pageID = "order-checkout-page";
    //digitalData.page.pageInfo.pageName = "ACS Demo - Order Checkout Page";
        ...
        <section className="section">
          <div className="container">
            ...
            <form className="col-md-4" style={formStyle}>
              <h2><span className="badge badge-secondary">Delivery preferences</span></h2>
              ...
              <div onChange={this.onDeliveryPreferenceChanged}>
                ...
                {deliveryCharges > 0 && (
                  <div className="mb-3">
                    *We charge an additional fee of ${deliveryCharges} for faster delivery.
                  </div>
                )}
              ...
              <div className="form-group">
                <button type="button" className="btn btn-primary btn-lg" onClick={this.handleClick}>
                  Pay <span className="badge badge-light">${total}</span> to complete the order
                </button>
              </div>
            </form>
          </div>
